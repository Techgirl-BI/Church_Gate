...
const Footer = () => {
  return (
    <div className='text-black mx-64 flex justify-between mt-14 mb-14'>
<div className='flex'>
...
<p className='text-4xl ml-4 italic font-normal'>Palace <br/> of <br/> Praise</p>
        ...
        <button className='font-bold relative right-11 text-xl w-fit h-fit mt-10  rounded-3xl px-9 py-2 border outline-2 border-black'>GIVE</button>
    </div>
  )
}
